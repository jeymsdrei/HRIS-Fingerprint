...
class Container_e317eeb9fe extends _PHPStan_b3f880679\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0474(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_e317eeb9fe $container)
			{
	...
	public function createServiceContainer(): Container_e317eeb9fe
	{
		return $this;
	}
